...
def get_pokemon(pokemon_id):
    ...
    if pokemon_data:
        return jsonify({
            ...
            'pokemon_type': pokemon_data[4],
            'pokemon_height': pokemon_data[5],
            'pokemon_weight': pokemon_data[6],
            'pokemon_xp_group': pokemon_data[7],
            'pokemon_abilities': pokemon_data[8],
            'pokemon_breed_period': pokemon_data[9],
            'pokemon_sex_ratio': pokemon_data[10],
            'pokemon_total_amount': pokemon_data[11],
            'pokemon_shine': pokemon_data[12],
            'pokemon_rarity': pokemon_data[13],
            'pokemon_health': pokemon_data[14],
            'pokemon_attack': pokemon_data[15],
            'pokemon_defence': pokemon_data[16],
            'pokemon_speed': pokemon_data[17],
            'pokemon_special_attack': pokemon_data[18],
            'pokemon_special_defence': pokemon_data[19],
            'pokemon_summ': pokemon_data[20]
        }), 200
    else:
