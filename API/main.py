...
def get_pokemon(pokemon_id):
    ...
    if pokemon_data:
        return jsonify({
            ...
            'pokemon_number': pokemon_data['pokemon_number'],
            'pokemon_xp_group': pokemon_data['pokemon_xp_group'],
            'pokemon_total_amount': pokemon_data['pokemon_total_amount'],
            'pokemon_shine': pokemon_data['pokemon_shine'],
            'pokemon_rarity': pokemon_data['pokemon_rarity'],
            'pokemon_title': pokemon_data['pokemon_title'],
            'pokemon_photo': pokemon_data['pokemon_photo'],
            'pokemon_name': pokemon_data['pokemon_name'],
            'pokemon_abilities': pokemon_data['pokemon_abilities'],
            'breed_period': pokemon_data['breed_period'],
            'sex_ratio': pokemon_data['sex_ratio'],
            'health': pokemon_data['health'],
            'attack': pokemon_data['attack'],
            'defence': pokemon_data['defence'],
            'speed': pokemon_data['speed'],
            'special_attack': pokemon_data['special_attack'],
            'special_defence': pokemon_data['special_defence'],
            'summ': pokemon_data['summ']
        }), 200
    else:
